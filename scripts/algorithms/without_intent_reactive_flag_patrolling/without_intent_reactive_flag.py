...
class CR:
    ...
    def __init__(self, g, num_bots):
        ...
        self.sim_dir = self.dirname + '/post_process/without_intent_reactive_flag/' + self.name
        ...
        self.dead_nodes = rng.choice([i for i in range(self.nodes)],self.no_of_deads,replace=False)
